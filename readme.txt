...
= 1.2.8 =
* Fixed: Customizer styles render issue

= 1.2.7 =
* Fixed: Theme check recommendations
...
= 1.2.4 =
* Added: Added E-Mail in Social Profiles

= 1.2.2 =
* Fixed: Stacked Header logo centering
* Added: Added Xing in Social Profiles
...
= 1.2.0 =
* Fixed: Trac Fixes
* Fixed: Menu Keyboard Navigation for Child Menu
...
* Added: Live Preview on Site Identity
* Updated: Compressed Fonts
* Updated: Added Posted & Updated date and schemas
* Fixed: Button Alignement Issue
* Fixed: Widget Fixes
